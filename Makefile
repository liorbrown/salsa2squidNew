...
ACLOCAL = ${SHELL} '/home/lior/squid-6.12/cfgaux/missing' aclocal-1.16
...
AUTOCONF = ${SHELL} '/home/lior/squid-6.12/cfgaux/missing' autoconf
AUTOHEADER = ${SHELL} '/home/lior/squid-6.12/cfgaux/missing' autoheader
AUTOMAKE = ${SHELL} '/home/lior/squid-6.12/cfgaux/missing' automake-1.16
AWK = gawk
BASIC_AUTH_HELPERS =  DB NCSA POP3 RADIUS SMB fake getpwnam
BUILDCXX = g++ -std=c++17
BUILDCXXFLAGS = -march=native      -g -O2 -march=native
...
EUILIB = 
EXEEXT = 
EXTERNAL_ACL_HELPERS =  SQL_session delayer file_userip kerberos_sid_group unix_group wbinfo_group
EXT_LIBECAP_CFLAGS = 
EXT_LIBECAP_LIBS = 
FALSE = /usr/bin/false
...
LT_SYS_LIBRARY_PATH = 
MAINT = #
MAKEINFO = ${SHELL} '/home/lior/squid-6.12/cfgaux/missing' makeinfo
MANIFEST_TOOL = :
MINGW_LIBS = 
MKDIR = /usr/bin/mkdir
...
PACKAGE_STRING = Squid Web Proxy 6.12
...
SQUID_CFLAGS =  -Werror -pipe -D_REENTRANT
SQUID_CXXFLAGS =  -Wall -Wextra -Wimplicit-fallthrough=5 -Wpointer-arith -Wwrite-strings -Wcomments -Wshadow -Wmissing-declarations -Woverloaded-virtual -Werror -pipe -D_REENTRANT
SQUID_RELEASE = 6
SSLLIB =  -lssl -lcrypto  
...
TR = /usr/bin/tr
TRUE = /usr/bin/true
URL_REWRITE_HELPERS =  LFS fake
VERSION = 6.12
WBINFO = 
WIN32_PSAPI = 
XTRA_LIBS = -lm -ldl
XTRA_OBJS = 
abs_builddir = /home/lior/squid-6.12
abs_srcdir = /home/lior/squid-6.12
abs_top_builddir = /home/lior/squid-6.12
abs_top_srcdir = /home/lior/squid-6.12
ac_ct_AR = 
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /home/lior/squid-6.12/cfgaux/install-sh
krb5_config = no
